...
<body class="bg-white">
    ...
    <header>
        ...
        <div class="search-bar">
            <input type="search" class="filtro-tarjeta" id="searchInput"
    ...
    <aside>
        ...
        <ul role="list" class="pb-6 space-y-4 text-sm font-medium text-gray-900 border-b border-gray-200">
            ...
            <li><a href="#">Juegos y Entretenimiento</a></li>
            <li><a href="#">Estudios</a></li>
            <li><a href="#">Salud y Bienestar</a></li>
            <li><a href="#">Medio Ambiente y Bienestar</a></li>
            <li><a href="#">Viajes y Turismo</a></li>
